        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
            <div class="banner-section">
                <div class="banner-img">
                    <img src="{{ asset('assets/img/vcard18/banner-img.png') }}" class="w-100 h-100 object-fit-cover"
                        alt="">
                </div>
            ...
            <div class="profile-section pb-40 px-30">
                <div class="card flex-sm-row-reverse align-items-center pt-sm-0 pt-4">
                    <div class="card-img d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets//img/vcard18/profile-img.png') }}"
                        ...
                        <svg width="19" height="20" viewBox="0 0 19 20" fill="none"
                            ...
                            <defs>
                                <clipPath id="clip0_603_322">
                                    <rect width="19" height="16.426" fill="white"
                        ...
                        <div class="col-sm-6">
                            <div class="contact-box d-flex align-items-center">
                                ...
                                <div class="contact-desc">
                                    ...
                                    <a href="mailto:jackie@gmail.com" class="fs-14 text-gray-200">jackie@gmail.com</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 mt-sm-0 mt-40">
                            <div class="contact-box d-flex align-items-center">
                                ...
                                <div class="contact-desc">
                                    ...
                                    <a href="tel:+1 4078461474" class="fs-14 text-gray-200">+1 4078461474</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="appointment-section pt-60 px-40">
                ...
                <div class="appointment">
                    <div class="row mb-3 pb-2">
                        <div class="col-sm-2">
                            <label for="date" class="appoint-date fs-18 fw-5 mt-sm-2 mb-sm-0 mb-2">Date:</label>
                        </div>
                        <div class="col-sm-10">
                            <div class="position-relative">
                ...
                <div class="gallery-slider pt-3 mt-3">
                    <div>
                        <div class="gallery-img">
                            <img src="{{ asset('assets//img/vcard18/gallery-img1.png') }}"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                    </div>
                    <div>
                        <div class="gallery-img">
                            <img src="{{ asset('assets//img/vcard18/gallery-img2.png') }}"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                    </div>
                    <div>
                        <div class="gallery-img">
                            <img src="{{ asset('assets//img/vcard18/gallery-img3.png') }}"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                    </div>
                    <div>
            ...
            <div class="product-section bg-gray pt-60 px-40">
                ...
                <div class="product-slider pb-0">
                    <div class="">
                        <div class="product-card card mb-3">
                            <div class="product-img card-img">
                                <img src="{{ asset('assets//img/vcard18/product-img1.png') }}"
                                    class="w-100 h-100 object-fit-cover" />
                            </div>
                    ...
                    <div class="">
                        <div class="product-card card mb-3">
                            <div class="product-img card-img">
                                <img src="{{ asset('assets//img/vcard18/product-img2.png') }}"
                                    class="w-100 h-100 object-fit-cover" />
                            </div>
                            <div class="product-desc card-body">
                                <div class="d-flex justify-content-between">
                ...
                <div class="blog-slider mb-0">
                    <div class="px-3">
                        <div class="blog-card d-flex flex-sm-row flex-column">
                            <div class="card-img">
                                <img src="{{ asset('assets//img/vcard18/blog-img.png') }}"
                ...
                <div class="d-inline-block w-100 mx-auto mt-40">
                    <div class="qr-code mx-auto position-relative">
                        <div class="qr-profile-img">
                            <img src="{{ asset('assets//img/vcard18/qr-profile-img.png') }}"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="qr-code-img mx-auto">
                            <img src="{{ asset('assets//img/vcard18/qr-code.png') }}"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group h-100">
                                        <textarea class="form-control h-100 ps-3" placeholder="{{ __('messages.form.type_message') }}" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="vcard-link-card card mb-5 mx-sm-4">
                    <div class="d-flex justify-content-center align-items-center">
                        <a href="https://vcards.infyom.com/marlonbrasil"
                            class="text-black link-text">https://vcards.infyom.com/marlonbrasil</a>
