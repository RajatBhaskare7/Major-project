                ...
                <div class="">
                    ...
                    <div class="col-lg-10 row phonepe-cred {{ !isset($selectedPaymentGateways['PhonePe']) ? 'd-none' : '' }}">
                        ...
                        <div class="form-group col-lg-6 mb-5">
                            ...
                            {{ Form::text('phonepe_merchant_transaction_id', $setting['phonepe_merchant_transaction_id'], ['class' => 'form-control phonepe_merchant_transaction_id ', 'placeholder' => __('messages.setting.phonepe_merchant_transaction_id')]) }}
                        </div>
                    </div>
                </div>
                <div class="">
