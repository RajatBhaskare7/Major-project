                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0 border-0" id="nav-tab" role="tablist">
                                    <button class="py-2 active postbtn instagram-btn text-dark border-0"
                                        id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                                        type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                                        <span class="px-1">{{ __('messages.vcard.post') }}</span></button>
                                    <button class="py-2 instagram-btn reelsbtn text-dark border-0"
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" method="post" id="newsLatterForm">
                            ...
                            <div class="input-group mb-3 mt-5">
                                <input type="email" class="text-white form-control bg-dark border-dark"
