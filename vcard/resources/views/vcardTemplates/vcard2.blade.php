            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="vcard-two__event py-3 px-3 ms-3">
                    ...
                    @if ($vcard->alternative_email)
                        <div class="event-details d-flex">
                            <div class="event-image">
                                <img src="{{ asset('img/vcard2/alter-image.png') }}" alt="email" height="20"
                                    width="27" />
                            </div>
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                    <button class="active postbtn instagram-btn fs-2 text-decoration-none py-2"
                                        id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                                        type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                                        <span class="px-1">{{ __('messages.vcard.post') }}</span></button>
                                    <button class="instagram-btn reelsbtn fs-2 text-decoration-none py-2"
